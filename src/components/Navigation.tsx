...
export const Navigation = () => {
  ...
  return <motion.nav className={cn("fixed top-0 left-0 right-0 z-50 transition-all duration-300", isScrolled ? "bg-white/80 backdrop-blur-lg border-b border-slate-200/50 shadow-lg" : "bg-transparent")} initial={{
    y: -100
  }} animate={{
    y: 0
  }} transition={{
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-2">
            <img src="/lovable-uploads/baf2979c-e25e-43f3-8f02-893f6200dcd2.png" alt="Voidr.Health" className="h-8 w-auto" />
          ...
          <div className="hidden md:flex items-center space-x-8">
            <div className="relative" onMouseEnter={() => setIsProductsOpen(true)} onMouseLeave={() => setIsProductsOpen(false)}>
              ...
              {isProductsOpen && <motion.div initial={{
              opacity: 0,
              y: 10
            }} animate={{
              opacity: 1,
